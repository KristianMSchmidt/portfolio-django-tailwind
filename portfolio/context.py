context = {
    'skills': {
        'python': {
            ...
            'description': ("I've built countless projects in Python, spanning from AI game agents "
            ...
            'img': {
                'width': "120",
                'url': 'img/python_logo.png'
            }
        },
        'django': {
            'title': "Full stack web development",
            'description': ("I use web frameworks such as Django and Flask to build web projects with Python "
            ...
            'img': {
                'width': "230",
                'url': 'img/django-logo.png'
            }
        },
        'php': {
            'title': "PHP development",
            'description': ("Before learning Django, I made full-stack web applications in the LAMP stack (Linux, Apache, MySql and PHP). "
                            "For an example, see my Bugtracker project below"),
            'img': {
                'width': "200",
                'url': 'img/php-logo-vector.svg'
            }
        },
        'frontend': {
            'title': "Front end development",
            'description': ("I use HTML, CSS, Javascript and Bootstrap to build responsive websites. I also use CSS prepocessors such as Sass. "
                            "You'll see examples of my front end skills in all my projects in the projects section."),
            'img': {
                'width': "120",
                'url': 'img/csshtmljs.jpeg'
            }
        },
        'database': {
            'title': "Data base development",
            'description': ("I have experience designing and queriyng relational databases using both raw SQL "
        ...
        'tailwind': {
            ...
            'description': ("In some of my later projects, including this portfolio, I've used the nice CSS framework Tailwind CSS. "
                            "Tailwind CSS makes development faster and gives nice aesthetic results."),
            'img': {
                'width': "160",
                'url': 'img/tailwind-css-logo.svg'
            }
        },
        'numpy': {
            'title': "Scientific computing",
            'description': ("I have written thousands of lines of code in scientific Python libraries such as Numpy, "
    ...
    'projects': {
        'bugtracker': {
            ...
            'description': ("This is a ticket tracking system that could be used by e.g. a sofware company to keep track of "
        ...
        'portfolio': {
            ...
            'description': ("I've styled this with Tailwind CSS. I use Django to include template components and to set up the email backend system. "
        ...
        'twentyfortyeight': {
            ...
            'description': ("Web app with an AI-player for the 2048-game. "
        ...
        'eightpuzzle': {
            ...
            'stack': 'Python, Flask, Html, Javascript, CSS, SCSS',
            'deployment': 'PythonAnywhere (PaaS)',
            'description': ("On this web app, you can construct and play with classic 8-puzzles (and more complicated 15-puzzles). "
        ...
        'sudoku': {
            ...
            'stack': 'Python, Flask, HTML, JavaScript, CSS, SCSS',
            'deployment': 'PythonAnywhere (PaaS)',
            'description': ("This is a speed optimized automatic sudoku solver using Back Tracking Search (BTS) and an Arc Consistency Algorithm (AC-3). "
                            "I originally made the python backend of this project as an assignment for Columbia University's "
                            "Artificial Intelligence MicroMasters Program. "
